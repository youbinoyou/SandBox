//
//  SandBoxCalendarViewController.m
//  SandBox
//
//  Created by CatenaRentalSystem on 2016/03/29.
...
static NSString * const ReuseIdentifier = @"CalendarDayCell";

static NSUInteger const DaysPerWeek = 7;

static CGFloat const CellMargin = 2.0f;

@interface SandBoxCalendarViewController ()
...
@implementation SandBoxCalendarViewController
...
{
    CalendarDayCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:ReuseIdentifier
