//
//  PageControlListViewController.m
//  SandBox
//
...
#import "PageControlListViewController.h"

@interface PageControlListViewController ()

@property (nonatomic,retain) NSArray *buttons;

@end

@implementation PageControlListViewController
