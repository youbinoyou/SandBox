//
//  NoScrollTableViewController.m
//  SandBox
//
//  Created by CatenaRentalSystem on 2015/11/17.
//  Copyright © 2015年 大島 曜. All rights reserved.
//
// http://aosicode.blog94.fc2.com/blog-entry-33.html
//

#import "NoScrollTableViewController.h"

@interface NoScrollTableViewController ()

@end

@implementation NoScrollTableViewController
...
- (void)viewDidAppear:(BOOL)animated {
    ...
    alertView.title = @"UITableView";
    alertView.message = @"スクロールをしないテーブルビュー";
